...
fn test_url_constructor_and_properties() {
    ...
    assert_eq!(logs[0], "href:https://example.com:8080/path/to/page?query=1&foo=bar#section1");
...
fn test_url_property_mutations() {
    ...
    let logs = doc.runtime.console;
    assert_eq!(logs[0], "mutated:http://example.com/new/path?a=b&c=d#heading");
}
...
fn test_url_search_params_methods_and_reactive_sync() {
    ...
    assert_eq!(logs[4], "toString:key1=val1&key2=updated&key1=val3&key1=val4");
    assert_eq!(logs[5], "sync_search:?lang=zh-TW&version=1&theme=dark");
    assert_eq!(logs[6], "sync_href:https://example.com/api?lang=zh-TW&version=1&theme=dark");
}
